...
def openTexttoSpeech():
    ...
    def Text_to_speech():
        ...
        speech.save('DataFlail.mp3')
        playsound('DataFlail.mp3')
        os.remove('DataFlail.mp3')
...
ttk.Label(root, text='  Multimedia Converter', style='TLabel', font=("Helvetica", 30)).grid(row=0, column=0, padx=70,
                                                                                            pady=20)
ttk.Label(root, text=' -  Select Operation - ', style='TLabel', font=("Helvetica", 15)).grid(row=1, column=0, padx=10,
                                                                                             pady=10)

ttk.Button(root, text="Image to Text", style='Outline.TButton', width=50, command=openImagetoText).grid(row=2, column=0,
                                                                                                        padx=50,
                                                                                                        pady=20)
ttk.Button(root, text="Audio to Text", style='Outline.TButton', width=50, command=openAudiotoText).grid(row=3, column=0,
                                                                                                        padx=50,
                                                                                                        pady=20)
ttk.Button(root, text="Text to Speech", style='Outline.TButton', width=50, command=openTexttoSpeech).grid(row=4,
                                                                                                          column=0,
                                                                                                          padx=50,
                                                                                                          pady=20)
ttk.Button(root, text="PDF merger", style='Outline.TButton', width=50, command=openPDFMerger).grid(row=5, column=0,
                                                                                                   padx=50, pady=20)
